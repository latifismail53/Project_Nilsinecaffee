...
?>
<div class="hero-wrap hero-bread" style="background-image: url('<?php echo get_theme_uri('images/kopi4.jpg'); ?>');">
  <div class="container">
...
<section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
  <div class="container mt-2">
    <div class="row">
      <div class="col-md-5 p-md-5 mb-3 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(<?php echo get_theme_uri('images/logo.png'); ?>);">
      </div>
...
<section class="ftco-section ftco-no-pb bg-dark">
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        <div class="display-3">TUGAS WEB PROGRAMMING 2</div>
      </div>
    </div>
  </div>
</section>
