...
<footer class="ftco-footer ftco-section">
  <div class="container">
    ...
    <div class="row mb-5">
      ...
      <div class="col-md">
        <div class="ftco-footer-widget mb-4 ml-md-5 text-dark">
  ...
  <div class="row">
    <div class="col-md-12 text-center">
      ...
      <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
        Copyright &copy;<script>document.write(new Date().getFullYear());</script> WebPrograming NusaMandiri | Dibuat Dengan <i class="icon-heart text-danger" aria-hidden="true"></i> Untuk Semua Mahasiswa.
    ...
    $.ajax({
      ...
      success: function (res) {
        if (res.code == 200) {
          ...
          toastr.info('Berhasil ditambahkan, Cek keranjang');
        }
        else {
