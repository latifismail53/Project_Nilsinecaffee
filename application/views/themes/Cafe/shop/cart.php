...
?>
<div class="hero-wrap hero-bread" style="background-image: url('<?php echo get_theme_uri('images/kopi5.jpg'); ?>');">
  <div class="container">
    <div class="row no-gutters slider-text align-items-center justify-content-center">
      <div class="col-md-9 ftco-animate text-center">
        <p class="breadcrumbs"><span class="mr-2"><?php echo anchor(base_url(), 'Home'); ?></span> <span style="text-shadow: 2px 2px 5px black;">Keranjang Belanja</span></p>
        <h1 class="mb-0 bread" style="text-shadow: 2px 2px 5px black;">Keranjang Belanja Saya</h1>
      </div>
    </div>
  </div>
</div>
       ...
       <div class="row justify-content-end">
        <div class="col-lg-4 mt-5 cart-wrap ftco-animate">
          <div class="cart-total mb-3">
            ...
            <p>Masukan kodemu untuk mendapatkan diskon hingga 30%</p>
        ...
        <div class="col-lg-4 mt-5 cart-wrap ftco-animate">
          <div class="cart-total mb-3">
            ...
            <p><button type="submit" class="btn btn-success btn-block py-3 px-4">Bayar <?php echo format_rupiah($total_cart); ?></button></p>
          </div>
        </div>
      </form>
      <?php else : ?>
        <div class="row">
          <div class="col-md-12 ftco-animate">
            <div class="alert alert-info">Yahh :( Pesanan Kamu masih kosong nih. <?php echo anchor('browse', 'Yuk! Pesan disini'); ?></div>
          </div>
        </div>
      <?php endif; ?>
    </div>
