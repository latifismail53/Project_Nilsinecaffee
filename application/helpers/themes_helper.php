...
// set pengambilan direktori tema dari database
    ...
    function get_template_part($file_name = null, $params = array()) {
        if ($file_name !== '') {
            ...
            if ( file_exists($file_location = VIEWPATH .'themes/'. $current_theme .'/'. $file_name .'.php')) {
                ...
                echo '<div>Rubah di dalam themes_helper <b>'. $file_name .'.php</b> ini juga gk ketemu coba setting lagi di databasenya.<br>Lokasi berkas: <b>'. $file_location .'</b></div>';
            }
        }
    }
}
