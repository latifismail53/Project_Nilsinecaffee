    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Order Saya</h1>
                    <h5>Untuk Pembayaran ditempat Klik Barcode dan tunjukan dikasir</h5>
                    <img src="" alt="">
                </div>
                <div class="col-sm-6">
                        ...
                        <table class="table table-striped m-0">
                            ...
                            <?php foreach ($orders as $order) : ?>
                                <tr>
                                    ...
                                    <td><?php echo ($order->payment_method == 1) ? 'Transfer bank' : '<a href="barcode/barcode.php">Barcode<a/>'; ?></td>
