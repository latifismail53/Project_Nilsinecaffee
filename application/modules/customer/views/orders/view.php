...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Order #<?php echo $data->order_number; ?> | <?php echo ($data->payment_method == 1) ? 'Transfer bank' : 'Tunjukan Barcode di kasir'; ?></h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card-body p-0">
                        <table class="table table-hover table-striped table-hover">
                            ...
                            <tr>
                                ...
                                <td><b><?php echo ($data->payment_method == 1) ? 'Transfer bank' : 'Bayar ditempat | <a href="../../barcode/barcode.php">Klik Barcode</a>'; ?></b></td>
                            </tr>
                            <tr>
                                <td>Status</td>
                ...
                <div class="card card-primary">
                    ...
                    <script>
                        $('.cancel-btn').click(function(e) {
                            ...
                            $(this).html('<i class="fa fa-spin fa-spinner"></i> Sedang Membatalkan Pesanan :(');
