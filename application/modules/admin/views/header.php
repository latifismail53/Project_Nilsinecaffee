...
<body class="@yield('sidebar_type')">
 <!-- Sidenav -->
 <nav class="sidenav navbar navbar-vertical fixed-left navbar-expand-sm navbar-light bg-secondary" id="sidenav-main">
   <div class="scrollbar-inner">
     <!-- Brand -->
     <div class="sidenav-header d-flex align-items-center">
       <a class="navbar-brand" href="<?php echo base_url(); ?>">
         WEB PROGRAMING<br>NUSA MANDIRI <img src="<?php echo get_store_logo(); ?>" class="navbar-brand-img" alt="Logo <?php echo get_store_name(); ?>">
       </a>
       <div class="ml-auto">
         <!-- Sidenav toggler -->
       ...
       <ul class="navbar-nav align-items-center ml-auto ml-md-0">
         ...
         <div class="dropdown-menu dropdown-menu-right">
           <div class="dropdown-header noti-title">
            <h6 class="text-overflow m-0">Hai Min!</h6>
          </div>
